"""
Django settings for eiurytowe_2 project.
...
WSGI_APPLICATION = 'eiurytowe_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "eiurytowe_2 API",
    "DESCRIPTION": "API documentation for eiurytowe_2 App",
    "VERSION": "v1",
}
